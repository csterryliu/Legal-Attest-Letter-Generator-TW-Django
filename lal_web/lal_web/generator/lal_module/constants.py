...
LETTER_FORMAT_PATH = os.path.join(BASE_HEROKU_DIR, 'lal_module/res/tw_lal.pdf')
DEFAULT_FONT_PATH = os.path.join(BASE_HEROKU_DIR, 'lal_module/res/TW-Kai-98_1.ttf')
_PDF_INCH = 72
########################################################################
